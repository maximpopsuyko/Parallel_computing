@echo off
::java -Xmx6048m -jar "%MPJ_HOME%"/lib/starter.jar %*
::goto :EOF
::echo %*
SET IS_NATIVE=false
...
SET COMMAND_TO_RUN=mpiexec %MPIRUN_ARGS% java -Xmx2048m -cp %CP%;. -Djava.library.path="%MPJ_HOME%"\lib %CLASS_NAME% 0 0 %DEV% %APP_ARGUMENTS%
